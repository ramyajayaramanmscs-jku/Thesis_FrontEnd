       ...
       <View style={styles.cardTop}>
         ...
         <Card>
           ...
           <Text style={styles.paragraph}>
             Granularity:Austria
             Update Interval-Daily update
             Availability:up-to-date(lagging by one week)
             Graph Interval: Year-Week-Month
           </Text>
         </Card>
       </View>
       <View style={styles.cardTop}>
         ...
         <Card>
           ...
           Update Interval-Daily update
           Availability:(lagging by two days)
           Graph Interval: Year-Week-Month
           </Text>
         </Card>
       </View>
